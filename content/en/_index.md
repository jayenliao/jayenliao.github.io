...
<div class="timeline">
  <div class="tl-item">
    ...
    <div class="tl-body"><span class="tl-title">Teaching Assistant — Generative AI Safety</span><br><span class="tl-sub">National Taiwan University · Designed and graded LLM-safety labs: prompt injection, jailbreaks, hallucination detection, DPO alignment</span></div>
  </div>
  <div class="tl-item">
    <div class="tl-date">Sep 2022 – Sep 2023</div>
    <div class="tl-body"><span class="tl-title">Data Scientist</span><br><span class="tl-sub">Fazz (Singaporean FinTech startup) · real-time anomaly detection, risk alerts, graph-based fraud analysis</span></div>
  </div>
  <div class="tl-item">
    <div class="tl-date">Aug 2020 – Aug 2022</div>
    <div class="tl-body"><span class="tl-title">Research & Teaching Assistant</span><br><span class="tl-sub">Networks & AI Lab, NCKU · graph-ML experiment pipelines for tabular prediction</span></div>
  </div>
</div>
...
<div class="pub-card">
  ...
  <div class="pub-authors">Yen-Ting Piao, <strong>Jay Chiehen Liao</strong>, Wei-Tang Chien, Toshiki Ogimoto, Shang-Tse Chen, Yun-Nung Chen, Chun-Yi Lee, Shao-Yuan Lo</div>
...
<div class="pub-card">
  ...
  <div class="pub-authors">Yu-Tai Lo, <strong>Jay Chiehen Liao</strong> (co-first author), Mei-Hua Chen, Chia-Ming Chang, Cheng-Te Li</div>
